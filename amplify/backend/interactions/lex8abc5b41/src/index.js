    ...
    let intentParams = [
        
        {
            ...
            "fulfillmentLambda": {
                ...
                "accountId": "885283880309",
                "lambdaArn": "arn:aws:lambda:ap-southeast-2:885283880309:function:Funct2",
                "lambdaName": "Funct2",
            },
            "fulfillmentActivity": {
                "type": "CodeHook",
                "codeHook": {
                    "messageVersion": "1.0",
                    "uri": "arn:aws:lambda:ap-southeast-2:885283880309:function:Funct2"
                }
            }, 
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "c54412ea",
